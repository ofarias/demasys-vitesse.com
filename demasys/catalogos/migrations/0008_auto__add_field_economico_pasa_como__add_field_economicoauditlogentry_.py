...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Economico.pasa_como'
        db.add_column(u'catalogos_economico', 'pasa_como',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'EconomicoAuditLogEntry.pasa_como'
        db.add_column(u'catalogos_economicoauditlogentry', 'pasa_como',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'ModeloEconomico.pasa_como'
        db.delete_column(u'catalogos_modeloeconomico', 'pasa_como')

        # Deleting field 'ModeloEconomicoAuditLogEntry.pasa_como'
        db.delete_column(u'catalogos_modeloeconomicoauditlogentry', 'pasa_como')


    def backwards(self, orm):
        # Deleting field 'Economico.pasa_como'
        db.delete_column(u'catalogos_economico', 'pasa_como')

        # Deleting field 'EconomicoAuditLogEntry.pasa_como'
        db.delete_column(u'catalogos_economicoauditlogentry', 'pasa_como')

        # Adding field 'ModeloEconomico.pasa_como'
        db.add_column(u'catalogos_modeloeconomico', 'pasa_como',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'ModeloEconomicoAuditLogEntry.pasa_como'
        db.add_column(u'catalogos_modeloeconomicoauditlogentry', 'pasa_como',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)
