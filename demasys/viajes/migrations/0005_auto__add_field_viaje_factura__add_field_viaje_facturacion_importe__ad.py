...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Viaje.factura'
        db.add_column(u'viajes_viaje', 'factura',
    ...
    def backwards(self, orm):
        # Deleting field 'Viaje.factura'
        db.delete_column(u'viajes_viaje', 'factura')
    ...
    models = {
        ...
        u'viajes.viaje': {
            ...
            'facturacion_importe': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '9', 'decimal_places': '2'}),
