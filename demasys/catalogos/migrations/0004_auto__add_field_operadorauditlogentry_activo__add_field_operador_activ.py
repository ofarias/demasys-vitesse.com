...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OperadorAuditLogEntry.activo'
        db.add_column(u'catalogos_operadorauditlogentry', 'activo',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Operador.activo'
        db.add_column(u'catalogos_operador', 'activo',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OperadorAuditLogEntry.activo'
        db.delete_column(u'catalogos_operadorauditlogentry', 'activo')

        # Deleting field 'Operador.activo'
        db.delete_column(u'catalogos_operador', 'activo')
