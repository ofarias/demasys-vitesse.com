...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OperadorAuditLogEntry.apellido_materno'
        db.alter_column(u'catalogos_operadorauditlogentry', 'apellido_materno', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Operador.apellido_materno'
        db.alter_column(u'catalogos_operador', 'apellido_materno', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'OperadorAuditLogEntry.apellido_materno'
        raise RuntimeError("Cannot reverse this migration. 'OperadorAuditLogEntry.apellido_materno' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'OperadorAuditLogEntry.apellido_materno'
        db.alter_column(u'catalogos_operadorauditlogentry', 'apellido_materno', self.gf('django.db.models.fields.CharField')(max_length=40))

        # User chose to not deal with backwards NULL issues for 'Operador.apellido_materno'
        raise RuntimeError("Cannot reverse this migration. 'Operador.apellido_materno' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Operador.apellido_materno'
        db.alter_column(u'catalogos_operador', 'apellido_materno', self.gf('django.db.models.fields.CharField')(max_length=40))
