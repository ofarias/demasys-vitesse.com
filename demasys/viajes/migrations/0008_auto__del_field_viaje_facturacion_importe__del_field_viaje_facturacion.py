...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Viaje.facturacion_importe'
        db.delete_column(u'viajes_viaje', 'facturacion_importe')
        ...
        # Adding field 'Viaje.facturacion_flete'
        db.add_column(u'viajes_viaje', 'facturacion_flete',
    ...
    def backwards(self, orm):
        # Adding field 'Viaje.facturacion_importe'
        db.add_column(u'viajes_viaje', 'facturacion_importe',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2),
                      keep_default=False)
        ...
        # Deleting field 'Viaje.facturacion_flete'
        db.delete_column(u'viajes_viaje', 'facturacion_flete')
    ...
    models = {
        ...
        u'viajes.viaje': {
            ...
            'facturacion_seguro': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '9', 'decimal_places': '2'}),
