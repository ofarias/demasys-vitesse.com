...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Gasto'
        db.create_table(u'viajes_gasto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tipo', self.gf('django.db.models.fields.IntegerField')()),
            ('concepto', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ...
            ('calculado', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True)),
            ('pagado_operaciones', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True)),
            ('pagado_contabilidad', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True)),
        ))
        db.send_create_signal(u'viajes', ['Gasto'])

        # Adding model 'Comprobante'
        db.create_table(u'viajes_comprobante', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gasto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['viajes.Gasto'])),
            ('archivo', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'viajes', ['Comprobante'])

        # Adding field 'Viaje.tipo_ruta'
        db.add_column(u'viajes_viaje', 'tipo_ruta',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'viajes_gasto')

        # Deleting model 'Comprobante'
        db.delete_table(u'viajes_comprobante')

        # Deleting field 'Viaje.tipo_ruta'
        db.delete_column(u'viajes_viaje', 'tipo_ruta')
