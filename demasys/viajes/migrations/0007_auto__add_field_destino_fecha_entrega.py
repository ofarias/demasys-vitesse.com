...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Destino.fecha_entrega'
        db.add_column(u'viajes_destino', 'fecha_entrega',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Destino.fecha_entrega'
        db.delete_column(u'viajes_destino', 'fecha_entrega')
