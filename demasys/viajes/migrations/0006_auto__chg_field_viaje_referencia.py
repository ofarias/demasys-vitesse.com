...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Viaje.referencia'
        db.alter_column(u'viajes_viaje', 'referencia', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Viaje.referencia'
        raise RuntimeError("Cannot reverse this migration. 'Viaje.referencia' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Viaje.referencia'
        db.alter_column(u'viajes_viaje', 'referencia', self.gf('django.db.models.fields.CharField')(max_length=150))
