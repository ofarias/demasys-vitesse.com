...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Viaje.facturacion_seguro'
        db.delete_column(u'viajes_viaje', 'facturacion_seguro')

        # Adding field 'Viaje.facturacion_maniobra'
        db.add_column(u'viajes_viaje', 'facturacion_maniobra',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2),
                      keep_default=False)

        # Adding field 'Viaje.facturacion_reparto'
        db.add_column(u'viajes_viaje', 'facturacion_reparto',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2),
                      keep_default=False)

        # Adding field 'Viaje.facturacion_desvio'
        db.add_column(u'viajes_viaje', 'facturacion_desvio',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2),
                      keep_default=False)

        # Adding field 'Viaje.facturacion_ferri'
        db.add_column(u'viajes_viaje', 'facturacion_ferri',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2),
                      keep_default=False)

        # Adding field 'Viaje.facturacion_otros'
        db.add_column(u'viajes_viaje', 'facturacion_otros',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2),
                      keep_default=False)

        # Adding field 'Viaje.observaciones'
        db.add_column(u'viajes_viaje', 'observaciones',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Viaje', fields ['flujo']
        db.create_unique(u'viajes_viaje', ['flujo_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Viaje', fields ['flujo']
        db.delete_unique(u'viajes_viaje', ['flujo_id'])

        # Adding field 'Viaje.facturacion_seguro'
        db.add_column(u'viajes_viaje', 'facturacion_seguro',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=9, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Viaje.facturacion_maniobra'
        db.delete_column(u'viajes_viaje', 'facturacion_maniobra')

        # Deleting field 'Viaje.facturacion_reparto'
        db.delete_column(u'viajes_viaje', 'facturacion_reparto')

        # Deleting field 'Viaje.facturacion_desvio'
        db.delete_column(u'viajes_viaje', 'facturacion_desvio')

        # Deleting field 'Viaje.facturacion_ferri'
        db.delete_column(u'viajes_viaje', 'facturacion_ferri')

        # Deleting field 'Viaje.facturacion_otros'
        db.delete_column(u'viajes_viaje', 'facturacion_otros')

        # Deleting field 'Viaje.observaciones'
        db.delete_column(u'viajes_viaje', 'observaciones')
