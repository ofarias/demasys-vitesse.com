...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClienteAuditLogEntry.nombre_corto'
        db.add_column(u'clientes_clienteauditlogentry', 'nombre_corto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Adding field 'Cliente.nombre_corto'
        db.add_column(u'clientes_cliente', 'nombre_corto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClienteAuditLogEntry.nombre_corto'
        db.delete_column(u'clientes_clienteauditlogentry', 'nombre_corto')

        # Deleting field 'Cliente.nombre_corto'
        db.delete_column(u'clientes_cliente', 'nombre_corto')
