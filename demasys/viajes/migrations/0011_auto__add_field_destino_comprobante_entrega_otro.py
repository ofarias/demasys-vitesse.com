...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Destino.comprobante_entrega_otro'
        db.add_column(u'viajes_destino', 'comprobante_entrega_otro',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Destino.comprobante_entrega_otro'
        db.delete_column(u'viajes_destino', 'comprobante_entrega_otro')
    ...
    models = {
        ...
        u'viajes.destino': {
            ...
            'comprobante_entrega_otro': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
