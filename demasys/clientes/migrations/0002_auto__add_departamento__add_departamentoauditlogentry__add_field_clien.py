...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'clientes_departamento', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('departamento', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.send_create_signal(u'clientes', ['Departamento'])

        # Adding model 'DepartamentoAuditLogEntry'
        db.create_table(u'clientes_departamentoauditlogentry', (
            ...
            ('action_user', self.gf('audit_log.models.fields.LastUserField')(related_name='_departamento_audit_log_entry', to=orm['auth.User'])),
            ('action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'clientes', ['DepartamentoAuditLogEntry'])

        # Adding field 'Cliente.activo'
        db.add_column(u'clientes_cliente', 'activo',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ClienteAuditLogEntry.activo'
        db.add_column(u'clientes_clienteauditlogentry', 'activo',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'clientes_departamento')

        # Deleting model 'DepartamentoAuditLogEntry'
        db.delete_table(u'clientes_departamentoauditlogentry')

        # Deleting field 'Cliente.activo'
        db.delete_column(u'clientes_cliente', 'activo')

        # Deleting field 'ClienteAuditLogEntry.activo'
        db.delete_column(u'clientes_clienteauditlogentry', 'activo')
