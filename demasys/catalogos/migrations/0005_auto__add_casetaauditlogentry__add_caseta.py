...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CasetaAuditLogEntry'
        db.create_table(u'catalogos_casetaauditlogentry', (
            ...
            ('motos', self.gf('django.db.models.fields.FloatField')()),
            ('autos', self.gf('django.db.models.fields.FloatField')()),
            ('autobus_2_ejes', self.gf('django.db.models.fields.FloatField')()),
            ('autobus_3_ejes', self.gf('django.db.models.fields.FloatField')()),
            ('autobus_4_ejes', self.gf('django.db.models.fields.FloatField')()),
            ('camion_2_ejes', self.gf('django.db.models.fields.FloatField')()),
            ('camion_3_ejes', self.gf('django.db.models.fields.FloatField')()),
            ('camion_4_ejes', self.gf('django.db.models.fields.FloatField')()),
            ('camion_5_ejes', self.gf('django.db.models.fields.FloatField')()),
            ('camion_6_ejes', self.gf('django.db.models.fields.FloatField')()),
            ('camion_7_ejes', self.gf('django.db.models.fields.FloatField')()),
            ('camion_8_ejes', self.gf('django.db.models.fields.FloatField')()),
            ('camion_9_ejes', self.gf('django.db.models.fields.FloatField')()),
            ...
            ('action_user', self.gf('audit_log.models.fields.LastUserField')(related_name='_caseta_audit_log_entry', to=orm['auth.User'])),
            ('action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'catalogos', ['CasetaAuditLogEntry'])

        # Adding model 'Caseta'
        db.create_table(u'catalogos_caseta', (
        ...
        db.send_create_signal(u'catalogos', ['Caseta'])


    def backwards(self, orm):
        # Deleting model 'CasetaAuditLogEntry'
        db.delete_table(u'catalogos_casetaauditlogentry')

        # Deleting model 'Caseta'
        db.delete_table(u'catalogos_caseta')
