...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Perfil'
        db.create_table(u'cuentas_perfil', (
            ...
            ('apellido_materno', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('telefono', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal(u'cuentas', ['Perfil'])


    def backwards(self, orm):
        # Deleting model 'Perfil'
        db.delete_table(u'cuentas_perfil')
